module.exports = function(cli, commands, additional){
  ...
  var args = {
      ...
      access_token:  ['t', "Access token to use to authorize request", "string", process.env['WPCOM_CLIENT_ACCESS_TOKEN']],
      client_id:     ['i', "WordPress.com Client ID", "string", process.env['WPCOM_CLIENT_ID']],
      client_secret: ['s', "WordPress.com Client Secret", "string", process.env['WPCOM_CLIENT_SECRET']],
